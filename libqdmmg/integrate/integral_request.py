...
def int_request(sim, request_string, *args, **kwargs):
    ...
    If the provided time t is not an integer, interpolated integrals are used. These are generated by using typical integration formulae and interpolating the inidividual Gaussian properties.
